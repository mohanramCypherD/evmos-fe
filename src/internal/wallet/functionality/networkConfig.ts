...
export const EVMOS_SYMBOL = "EVMOS";
export const EVMOS_DECIMALS = 18;
export const EVMOS_COSMOS_EXPLORER = "https://escan.live/";
export const EVMOS_ETH_CHAIN_ID = "0x2329";
...
export const EVMOS_BACKEND = "https://goapi2.evmos.org";
