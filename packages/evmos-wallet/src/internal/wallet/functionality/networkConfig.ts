...
export const EVMOS_CHAIN_NAME = process.env.NEXT_PUBLIC_EVMOS_CHAIN_NAME ?? "Evmos";
export const EVMOS_SYMBOL = process.env.NEXT_PUBLIC_EVMOS_SYMBOL ?? "EVMOS";
export const EVMOS_DECIMALS = parseInt(process.env.NEXT_PUBLIC_EVMOS_DECIMALS ?? "18");
export const EVMOS_COSMOS_EXPLORER =
  process.env.NEXT_PUBLIC_EVMOS_COSMOS_EXPLORER ?? "https://escan.live/";
export const EVMOS_ETH_CHAIN_ID = process.env.NEXT_PUBLIC_EVMOS_ETH_CHAIN_ID ?? "0x2329";
...
export const OSMOSIS_CHAIN_ID = process.env.NEXT_PUBLIC_OSMOSIS_CHAIN_ID ?? "osmosis-1";
